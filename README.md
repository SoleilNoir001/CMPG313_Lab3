# CMPG313 Lab 3: AI Chat Comparison

This project compares **ELIZA**, a rule-based chatbot (past AI), with a **GPT-2** based chatbot (present AI).  
The goal is to show the differences between simple, rule-based AI and modern generative AI.
